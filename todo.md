...
| 30  | CWV-optimering Fas 1 (CLS, JS, images)          | Fas A+B+C + self-host deployade. LCP 9.6s→1.6s (-84 %), perf 51→80. Kvar: CrUX-mätning 28d          | [todos/30-cwv-optimering.md](todos/30-cwv-optimering.md)                   |
