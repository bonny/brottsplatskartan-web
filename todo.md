...
| 28  | Migrera AI-stack till `laravel/ai`              | Plan klar 2026-04-26 — 6 faser inkl. modell-utvärdering (Sonnet→Haiku, ~$30/mån sparas) + prompt-genomgång. Blocker för #10 + #27 Lager 3   | [todos/28-migrera-laravel-ai.md](todos/28-migrera-laravel-ai.md)           |
