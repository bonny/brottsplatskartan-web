...
Senast uppdaterad: 2026-05-12 (+#63 Fas 1 byggd lokalt — Haiku-pilot 8/8 precision, väntar på deploy).
...
| 63  | Relaterade nyheter — prio:a high-traffic events         | Fas 1 byggd lokalt 2026-05-12 (Haiku event×artikel-matchning, Mediabevakning-sektion) — väntar deploy | [todos/63-relaterade-nyheter-trafikprio.md](todos/63-relaterade-nyheter-trafikprio.md)               |
