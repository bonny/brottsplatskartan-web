...
Senast uppdaterad: 2026-05-06 (+#69 SMHI vädervarningar som kart-layer — scope A efter SEO/annons/UX-granskning).
...
| 68  | Höj agent-readiness-betyg (isitagentready.com)          | Quick wins implementerade lokalt 2026-05-06 (sitemap-cookies, Link-headers, Content Signals, api-catalog) — väntar deploy + re-scan | [todos/68-agent-readiness-betyg.md](todos/68-agent-readiness-betyg.md)                               |
