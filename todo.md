...
Senast uppdaterad: 2026-05-13 (+#74 LICENSE klar — bytte MIT → AGPL v3, täpper SaaS-luckan mot kommersiell kloning).
...
| 73  | Konkurrent-analys + utvärdera privat repo               | Fas 1+3 klara 2026-05-13 — IP-beslut: öppet under AGPL v3 (täpper SaaS-luckan). LICENSE klar (#74). Nästa: bryt ut inspirations-todos | [todos/73-konkurrent-analys.md](todos/73-konkurrent-analys.md)                                     |
