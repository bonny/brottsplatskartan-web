...
| 81  | Håll koll på hur mycket AI-anropen kostar               | Fas 1 + tre lågrisk-spakar deployade 2026-05-15 → $10.40 → $2.60/dygn (~74 % besparing). GA4-CTR ~1.7 klick/dygn = $1.62/klick. 7d-uppföljning 2026-05-23. | [todos/81-ai-kostnad-overvakning.md](todos/81-ai-kostnad-overvakning.md)                                             |
...
| 2026-05-23 | #81 7d-uppföljning: `ai:usage --days=7 --by=agent` + GA4-klick/CTR per nyhetsdomän — bekräfta $2.60/dygn håller och CTR-trend | [#81](todos/81-ai-kostnad-overvakning.md)              |
