...
')
     ...
     */ 
         ...
         * @static 
         */ 
        public static function parse($text = '', $options = [])
        {
                        /** @var \AlfredoRamos\ParsedownExtra\ParsedownExtraLaravel $instance */
                        return $instance->parse($text, $options);
        }
                    /**
         * 
         *
        ...
        {            //Method inherited from \Parsedown         
                        /** @var \AlfredoRamos\ParsedownExtra\ParsedownExtraLaravel $instance */
                        return $instance->setBreaksEnabled($breaksEnabled);
        }
                    /**
         * 
         *
        ...
        {            //Method inherited from \Parsedown         
                        /** @var \AlfredoRamos\ParsedownExtra\ParsedownExtraLaravel $instance */
                        return $instance->setMarkupEscaped($markupEscaped);
        }
                    /**
         * 
         *
        ...
        {            //Method inherited from \Parsedown         
                        /** @var \AlfredoRamos\ParsedownExtra\ParsedownExtraLaravel $instance */
                        return $instance->setUrlsLinked($urlsLinked);
        }
                    /**
         * 
         *
         * @static 
         */ 
        public static function setSafeMode($safeMode)
        {            //Method inherited from \Parsedown         
                        /** @var \AlfredoRamos\ParsedownExtra\ParsedownExtraLaravel $instance */
                        return $instance->setSafeMode($safeMode);
        }
                    /**
         * 
         *
         * @static 
         */ 
        public static function line($text, $nonNestables = [])
        {            //Method inherited from \Parsedown         
                        /** @var \AlfredoRamos\ParsedownExtra\ParsedownExtraLaravel $instance */
                        return $instance->line($text, $nonNestables);
        }
                    /**
         * 
         *
        ...
        {            //Method inherited from \Parsedown         
                        return \AlfredoRamos\ParsedownExtra\ParsedownExtraLaravel::instance($name);
        }
