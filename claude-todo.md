...
| 6   | Flytta Brottsstatistik → `/statistik`               | **V1 klar 2026-04-21** (sidan skapad, startsida beslut kvar) | [claude-todos/06-statistik-sida.md](claude-todos/06-statistik-sida.md)     |
