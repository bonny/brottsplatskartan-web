**Status:** aktiv monitor. **Kvartalsrapport 2026-08-02 klar** (försenad från 07-30 — mcp-gsc låg nere, krävde `mcp[cli]<2`). Rapport: `tmp-gsc-52-2026-08-02/RAPPORT.md`. Utfall: "senaste blåljusen stockholm" **återhämtad** (pos 6,7→6,0, CTR 5,1→9,13 %, klick 354→1 488) efter den breddade /stockholm-titeln; #54 trafikkontroll impressioner 3,3× men pos står still 9,1; "polisen händelser" pos 7,5→6,5 och har vuxit ur låg-rank-filtret. Total potential 44 833 klick/90d (från ~24 800) — driven av volymökning, inte positionstapp. Nya kluster: nyhetshändelser (Isaberg ~40 000 imp), räddningstjänst/SOS Alarm över flera städer, "utryckning [stad] idag". Rekommenderat nästa: `aktuella brott` (pos 3,7 men CTR 0,41 % — titel/snippet), Uppsala+Örebro som Tier 1-kandidater. `polisen` avskriven (17 klick / 14 206 imp). Kvar sedan tidigare: A (vänta #76 Fas B), B (utöka #76). Nästa rapport 2026-11-01.
