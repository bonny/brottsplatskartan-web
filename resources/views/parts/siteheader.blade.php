    ...
    <div class="SiteHeader__inner">
        ...
        <h1 class="SiteTitle"><a href="/">
                <div class="SiteHeader__icon">
                    <img loading="lazy" src="/img/brottsplatskartan-logotyp.png" width="269" height="31"
        ...
        <nav class="SiteNav">
            <ul class="SiteNav__items">
                <li class="SiteNav__item SiteNav__item--latest">
                    <a href="{{ route('start') }}">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="white" width="18px"
                            height="18px">
                ...
                <li class="SiteNav__item SiteNav__item--mostRead">
                    <a href="{{ route('mostRead', [], false) }}">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="#fff" width="18px"
                            height="18px">
                ...
                <li class="SiteNav__item SiteNav__item--sverigekartan">
                    <a href="{{ route('sverigekartan', [], false) }}">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="white" width="18px"
                            height="18px">
                            <path
                ...
                <li class="SiteNav__item SiteNav__item--search">
                    <a href="{{ route('adsenseSearch', [], false) }}">
                        <svg fill="#fff" height="18" viewBox="0 0 24 24" width="18"
                            xmlns="http://www.w3.org/2000/svg">
                            <path
